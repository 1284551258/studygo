...
// 博客地址：https://www.liwenzhou.com/posts/Go/go_elasticsearch/
/*
Elasticsearch
发布于2019/04/28 ,更新于2019/04/28 19:31:00 | Golang |总阅读量：12981次
...
curl -H "ContentType:application/json" -X PUT 127.0.0.1:9200/user/person/_search -d '
{
	"query":{
		"match": {"name": "sb"}
	}
